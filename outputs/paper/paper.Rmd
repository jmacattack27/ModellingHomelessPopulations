...
```{r housingattrition, fig.cap = 'Moved to Housing vs Returned from Housing', fig.width = 8, fig.height = 4, echo = FALSE, message = FALSE, warning = FALSE, out.width = '80%', fig.align = "center"}
